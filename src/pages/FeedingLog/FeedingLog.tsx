...
import { DEFAULT_CAMPIST_NEW_API } from "@/constants/campist";
import {
  foodDays,
  foodTypes,
  FRIDAY,
...
const FeedingLog = () => {
  ...
  const [selectedCampist, setSelectedCampist] = useState(
    DEFAULT_CAMPIST_NEW_API
  );
  ...
  const onCampistChange = (_, newValue) => {
    setSelectedCampist(newValue ?? DEFAULT_CAMPIST_NEW_API);
  };
